...
namespace PasswordManager
{
    public partial class PasswordManagerForm
    {
        ...
        private void LoginUsernameInput_Enter(object sender, EventArgs e)
        {
            ...
            LoginUnderline1.BackColor = Color.FromArgb(225, 225, 225);
        }
        ...
        private void LoginUsernameInput_Leave(object sender, EventArgs e)
        {
            if (LoginUsernameInput.Text == "")
            {
                ...
                LoginUnderline1.BackColor = Color.Gray;
            }
        }
        ...
        private void LoginPasswordInput_Enter(object sender, EventArgs e)
        {
            ...
            LoginUnderline2.BackColor = Color.FromArgb(225, 225, 225);
        }
        ...
        private void LoginPasswordInput_Leave(object sender, EventArgs e)
        {
            if (LoginPasswordInput.Text == "")
            {
                ...
                LoginUnderline2.BackColor = Color.Gray;
            }
        }
        ...
        private void RegisterUsernameInput_Enter(object sender, EventArgs e)
        {
            ...
            RegistrationUnderline1.BackColor = Color.FromArgb(225, 225, 225);
        }
        ...
        private void RegistrationUsernameInput_Leave(object sender, EventArgs e)
        {
            if (RegistrationUsernameInput.Text == "")
            {
                ...
                RegistrationUnderline1.BackColor = Color.Gray;
            }
        }
        ...
        private void RegisterPasswordInput_Enter(object sender, EventArgs e)
        {
            ...
            RegistrationUnderline2.BackColor = Color.FromArgb(225, 225, 225);
        }
        ...
        private void RegistrationPasswordInput_Leave(object sender, EventArgs e)
        {
            if (RegistrationPasswordInput.Text == "")
            {
                ...
                RegistrationUnderline2.BackColor = Color.Gray;
            }
        }
        ...
        private void RegisterConfirmPasswordInput_Enter(object sender, EventArgs e)
        {
            ...
            RegistrationUnderline3.BackColor = Color.FromArgb(225, 225, 225);
        }
        ...
        private void RegistrationConfirmPasswordInput_Leave(object sender, EventArgs e)
        {
            if (RegistrationConfirmPasswordInput.Text == "")
            {
                ...
                RegistrationUnderline3.BackColor = Color.Gray;
            }
        }
        ...
        private void Login()
        {
            ...
            if (!File.Exists(Path.Combine(filePath, username + ".txt")))
            {
            ...
            if (Encrypter.ComputeSHA256(LoginPasswordInput.Text) == password)
            {
        ...
        private bool ValidateRegistration(bool overwrite = false)
        {
            ...
            if (File.Exists(Path.Combine(filePath, RegistrationUsernameInput.Text.ToLower() + ".txt")))
            {
                if (!overwrite)
                {
            ...
            {
                RegistrationFeedback.Text = "Invalid password, please make sure password and confirm password match and they are both at least 8 characters long and contain both capital and lower letters!";
                return false;
            }
        ...
        private void CreateAccount(bool overwrite = false)
        {
            ...
            try
            {
                password = Encrypter.ComputeSHA256(RegistrationPasswordInput.Text);
        ...
        {
            ClearData();
            ResetInputField(AccountSearchBar, "Search...", true);
